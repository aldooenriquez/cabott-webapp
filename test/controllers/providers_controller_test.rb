...
class ProvidersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create provider" do
    assert_difference("Provider.count") do
      post providers_url, params: { provider: { country: @provider.country, email: @provider.email, name: @provider.name } }
    end
  ...
  test "should update provider" do
    patch provider_url(@provider), params: { provider: { country: @provider.country, email: @provider.email, name: @provider.name } }
