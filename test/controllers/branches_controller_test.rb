...
class BranchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create branch" do
    assert_difference("Branch.count") do
      post branches_url, params: { branch: { code: @branch.code, country: @branch.country, name: @branch.name, state: @branch.state } }
    end
  ...
  test "should update branch" do
    patch branch_url(@branch), params: { branch: { code: @branch.code, country: @branch.country, name: @branch.name, state: @branch.state } }
